...
class CandidateSelfProfile extends React.Component {
  ...
  addProjectCloseForm = (title, description, startDate, endDate, current, link, editable) => {
    this.addProject(title, description, startDate, endDate, current, link, editable);
