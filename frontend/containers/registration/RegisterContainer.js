  ...
  render() {
    ...
    return (
      <div>
        ...
        <Route exact path="/register/cand/education"
        ...
        <Route exact path="/register/cand/profile"
        ...
        <Route exact path="/register/cand/additional"
        ...
        <PrivateRouteCand
          exact path="/register/cand/pending"
          component={ Pending }
          loggedInCand={this.props.loggedInCand}
          loggedInTemp={this.props.loggedInTemp}
          registerCand={this.props.registerCand} />
